...
export default function Navbar(){
    ...
    return(  
    <>
    <nav className=" bg-stone-500 p-3 fixed left-0 right-0 top-0 z-[9999] ">
        <div className="container flex gap-8 ">
            ...
            {userToken!==null?(
               ...
               lg:flex-row lg:static lg:bg-transparent lg:gap-y-0 lg:shadow-none lg:py-0 lg:w-auto ${dropMenu ? "top-14" : "-top-60"}`}>
                ...
                <ul className="flex gap-3 lg:hidden text-black">
                <li>
            ...
            <ul className="flex gap-6 items-center ms-auto">
                {userToken !==null?(
                    ...
                    <i className="fa-regular fa-heart text-2xl" style={{color:'black'}}></i>
                    </Link>
                    </li>
                     <li className="mr-5">
                    <Link to="/cart" className="relative">
                    <i className="fa-solid fa-cart-shopping text-2xl"style={{color:'black'}}></i>
            ...
            <ul className="flex gap-6 items-center">
                ...
                <li className="cursor-pointer">
                    <span onClick={logout}><i className="fa-solid fa-right-from-bracket " style={{color:'red'}}></i></span>
                </li>
              )
